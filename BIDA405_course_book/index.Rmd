--- 
title: "Data Analytics Provisioning, Importing, Extracting and Manipulation: UVic BIDA405"
...
links-as-notes: true
colorlinks: true
cover-image: garbage_in_statistic_out.png
#github-repo: MonkmanMH/DataScienceResources_book
description: "The course book for BIDA405"
---
...
<img src="garbage_in_statistic_out.png" width="350" height="350" alt="BIDA302 hex" />

_Draft_

This book is based on the lessons for BIDA405, "Data Analytics Provisioning, Importing, Extracting and Manipulation", offered at the University of Victoria's Continuing Studies Department.


## Course description {-}

From [UVic Continuing Studies website](https://continuingstudies.uvic.ca/business-technology-and-public-relations/courses/data-analytics-provisioning-importing-extracting-and-manipulation)

> Learn how to import, extract, scrape, clean, compile, manipulate and export data in common industry tools such as R, Python and JavaScript. Learn how to construct scripts to solve problems and also apply safeguards to data for privacy and security in a data analytics framework.
...
In addition to the material in this ebook, see [@Grossman_Rinderle-Ma_2015]
...
The book's layout is currently in 12 chapters, each corresponding to the 12 lessons of the course:
...
The source code for this ebook can be found at this github repository: https://github.com/MonkmanMH/UVic_BIDA405 
...
The image is by [Oliver Hoeller](http://oliverhoeller.com/) and was taken from the blog post ["Garbage in, garbage out"](https://totalinternalreflectionblog.com/2018/09/11/garbage-in-garbage-out/) by Brooke Morriswood.
