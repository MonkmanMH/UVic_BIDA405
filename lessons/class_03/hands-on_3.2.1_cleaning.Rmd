...
From the `case_when()` reference page:

Note that this is using different combinations of three variables to create a single fourth variable.
...
# Generate a vector 
set.seed(158)
x <- round(rnorm(100, 10, 5)) #random, normal distribution, 20 cases, mean of 10, s.d. of 5
