...
In both cases, we get 5 "fails". How can we check which records have failed? {validate} provides another function, `confront()`, which provides a detailed record-by-record account of which records have failed our test.
