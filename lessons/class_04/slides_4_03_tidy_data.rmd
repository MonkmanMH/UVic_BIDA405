...
* stored remotely—efficient use of comptuer memory

???

You have so much data that it does not all fit into memory simultaneously and you need to use some external storage engine. {dbplyr}
...
![Getting started with SQL](Getting_started_with_SQL.jpg)
