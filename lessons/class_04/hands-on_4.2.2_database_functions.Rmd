...
* the People file contains the personal details of each individual employed by the enterprise, for the years 2000 through 2018.
...
A: Since all of the data in `People` is constant (name, birthdate, etc) there is no need to repeat those variables in the other tables where there are multiple records for the same player. It also means that this contsistent data only has to be edited in one location, not across all of the tables.
