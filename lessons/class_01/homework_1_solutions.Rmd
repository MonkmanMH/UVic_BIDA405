...
There are differences around the world as how to indicate the decimal portion of a number (here in North America we use a period, as in 3.14159) but in most European countries they use a comma (3,14159). As well, the use of digit separators in large numbers is common; the North American approach is to use a comma (so one thousand is represented as 1,000) and in other countries a space will be used (1 000).
...
3a. _What are the pros of a delimited file storage solution, compared to a fixed width?_

3b. _You've just received a plain-text data file from a colleague in Quebec. What sorts of things will you have to watch out for in how the data are encoded?_
