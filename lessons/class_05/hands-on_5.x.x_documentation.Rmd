...
So what are the elements of effective recordkeeping? Some of the things to note:
...
* how the analysis was done (a high-level statement: "this analysis used the data from 2010 through 2019, calculated average per month volumes, and used an ARIMA model to develop a 6 month forecast")
