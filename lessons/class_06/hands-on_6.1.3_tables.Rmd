...
In this code chunk, we start with the unformatted pivot table, and add all of the formatting code from above—plus grouping the provinces and territories, using the `pack_rows()` function.
