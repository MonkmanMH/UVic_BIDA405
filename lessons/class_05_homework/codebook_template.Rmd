...
Load the data into the environment. I've called the object `codebook_data` since that works further down in the code that's already written. (Painting sombreros on the pandas!)


```{r}
library(gapminder)
# load the gapminder table as a dataframe
codebook_data <- gapminder
