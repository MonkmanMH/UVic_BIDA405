...
{eurostat} - Tools for Eurostat Open Data - https://cran.r-project.org/web/packages/eurostat/index.html

### APIs

* https://www.dataquest.io/blog/r-api-tutorial/ -- using the the {httr} and {jsonlite} packages


* https://www.r-bloggers.com/accessing-apis-from-r-and-a-little-r-programming/#:~:text=There%20are%20many%20facilities%20in,lot%20by%20the%20jsonlite%20package.
